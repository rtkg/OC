...
h(1)=rectangle('Position',[-0.02 0 0.04 segway.l_],'FaceColor','k','EdgeColor','k');
...
h(4)=rectangle('Position',[-0.08 segway.l_-0.08 0.16 0.16],'Curvature',[1 1],'FaceColor','b','EdgeColor','b');
